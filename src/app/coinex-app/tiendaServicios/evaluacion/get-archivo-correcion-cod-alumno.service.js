(function() {
	...
	angular
		...
		.factory('getArchivoCorrecionCodAlumnoService', getArchivoCorrecionCodAlumnoService);

	function getArchivoCorrecionCodAlumnoService($coinexHttp, $q, newAddressResponseFake) {
	...
	Handlers.prototype = {
		...
		action: function(command, success, failed) 
        {
            var data = {	
				...
				cod_estudiante:     command.cod_alumno
			};
			return this.coinexHttp.http.post(localStorage.getItem("apiUrl") +'Evaluacion/getArchivoCorrecionCodAlumno', data);
		},
