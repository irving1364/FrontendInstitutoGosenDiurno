(function() {
	...
	angular
		...
		.factory('getArchivoEvaluaUserService', getArchivoEvaluaUserService);

	function getArchivoEvaluaUserService($coinexHttp, $q, newAddressResponseFake) {
	...
	Handlers.prototype = {
		...
		action: function(command, success, failed) {
            var data = {	
				...
				cod_evalua:        	command.cod
			};
			return this.coinexHttp.http.post(localStorage.getItem("apiUrl") +'Evaluacion/getArchivoEvaluaAlumno', data);
		},
